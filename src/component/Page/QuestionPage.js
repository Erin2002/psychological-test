...
export default function QustionPage({ questionIndex, nextStep
}) {
    ...
    return (
        <>
            <MobileFrame>
                QustionPage:Q{questionIndex + 1}
                <div className="flex justify-center items-center flex-col gap-[60px]">
                        <Image className="absolute top-0 -translate-y-1/2" src={blur_circle_0}></Image>
                        <Image className="absolute bottom-0 translate-y-1/2" src={blur_circle_0}></Image>
